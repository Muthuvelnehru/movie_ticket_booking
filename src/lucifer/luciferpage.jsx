        ...
        <div className='bgimagefight ' style={{marginTop:"80px"}}>
           ...
           <div className='container'>
            ...
            <div className='text-center col-12 col-lg-3 order-2 order-md-1 align-items-center'>
                <img style={{height:"330px" ,width:"230px"}} src='https://accelmedia.in/wp-content/uploads/2020/01/Lucifer_Top1.jpg' />
            ...
            <iframe width="100%" height="90%" src="https://www.youtube.com/embed/x1-Ya0NZQso?si=ye3EVpZF2lSJMWMO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            ...
            <div className=' order-4 p-3 borderbottom'>
                <h3 style={{color:'#00ffff'}}>Director </h3>  <p> Abbas A Rahmath</p>
            </div>
            <div className=' order-5 p-3 borderbottom'>
                <h3 style={{color:'#00ffff'}}>Stars </h3> <p>      Vijay Kumar • Monisha Mohan Menon • Avinash Raghudevan</p>
            </div>
        </div>
        </div>
